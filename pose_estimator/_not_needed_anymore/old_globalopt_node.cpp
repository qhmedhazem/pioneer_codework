...
std::mutex m_buf;
ros::Subscriber sub_GPS, sub_vio;
...
{    
    ...
    ros::Subscriber sub_vio = n.subscribe("/odometry", 100, globalopt_vio_callback);
...
int main(int argc, char **argv) {
    ...
    ros::NodeHandle n("~");
    init_globalopt_node(config_file, n);
    ros::spin();
